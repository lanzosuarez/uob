    ...
    return ( <
      ...
      Content > {
        this.props.profile === null ? null : ( <
          ...
          /> <
          FieldName field = "Function/segment"
          value = {
            this.props.profile.department
          }
          /> <
          FieldName field = "Supervisor's name"
          value = {
            this.props.profile.supervisor_name
          }
          /> <
          FieldName field = "Supervisor's email"
          value = {
            this.props.profile.supervisor_email
          }
          /> <
          ListItem onPress = {
          ...
          /Separator> <
          CourseFieldName onPress = {
            () => this.props.navigation.push("UpcomingCourses")
          }
          field = "Upcoming Courses" /
          >
          <
          CourseFieldName onPress = {
            () => this.props.navigation.push("PastCourses")
          }
          field = "Past Courses" /
          >
          <
          CourseFieldName onPress = {
            () => this.props.navigation.push("SignAttendance")
          }
          ...
          /> {
            this.props.user && this.props.user.is_supervisor ? ( <
              ...
              /Separator> <
              CourseFieldName onPress = {
                () => this.props.navigation.push("CourseBookings")
              }
